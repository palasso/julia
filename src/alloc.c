...
jl_value_t *jl_empty_vec_any=NULL;
...
static jl_lambda_info_t *jl_instantiate_staged(jl_method_t *generator, jl_tupletype_t *tt, jl_svec_t *env)
{
    ...
    JL_TRY {
        ...
        jl_array_ptr_set(body->args, 1, jl_call_staged(sparam_vals, func,
...
{
    jl_array_t *ar = n==0 ? (jl_array_t*)jl_empty_vec_any : jl_alloc_vec_any(n);
    JL_GC_PUSH1(&ar);
